...
% NOTE: GLUC requires the following files be located in the model folder:
    ...
    % parameters.csv marginal_demand.csv outputfile_counter.xls 
    % extense_calibra_by_country_calibrated.csv
    % intense_calibra_by_country_calibrated.csv

% NOTE: data_path.csv, parameters.csv, and marginal_demand.csv must be 
...
%   parameters for the model run; marginal_demand.csv must contain the 
...
% Extract marginal demand values from CSV file
    demand_table = readtable('marginal_demand.csv');
